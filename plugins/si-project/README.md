# si-project — AI Agent 기반 SI 프로젝트 산출물 플러그인 (v2.0.0)
...
├── reference/
│   ├── methodology.md           ★ 방법론 지식 (작성 가이드, 마커 기반 lazy)
│   └── doc-catalog.md           ★ 106개 문서 카탈로그
├── skills/
│   ├── project-setup/
│   │   ├── SKILL.md            (283줄, 워크플로 로직만)
│   │   └── reference/          (인라인 템플릿 분리: questions, claude-md-template, settings, git-files, project-files, adr, ci-workflows)
